        ...
        <div className="flex justify-between items-center w-full">
          ...
          <form className="flex items-center w-full sm:max-w-xs">
            ...
            <div className="relative w-full">
              ...
              <input type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="cari tiket berdasarkan nama"  value={searchTerm}

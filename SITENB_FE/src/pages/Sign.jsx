...
const Sign = () => {
  ...
  // Validasi reCAPTCHA
  if (!recaptchaToken) {
    toast.error("Mohon selesaikan reCAPTCHA terlebih dahulu.");
    return;
  }
    ...
    try {
      ...
      if (permissions && permissions['roles.index']) {
        ...
        localStorage.setItem('role', "user");
        toast.success('Login berhasil! Mengarahkan ke halaman user...');
        setTimeout(() => {
          navigate("/tes");
        }, 3000);
      }
        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              {/* <ReCAPTCHA
    sitekey="6LdurUEqAAAAAMnZDI8NyJgz9CIDpXicoCJK9kQP"
    onChange={setRecaptchaToken}
    required
  /> */}
     {/* <ReCAPTCHA
                sitekey="6Lf7tUsqAAAAANhzmdnQqygsGgRqinNjtUaUQ36u"  
